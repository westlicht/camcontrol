...
/*..........................................................................*/
static void interrupt tickISR() {                             /* see NOTE01 */

    QF_tick();                          /* process all time events (timers) */
    Video_printNumAt(20, 17, VIDEO_FGND_YELLOW, ++l_tickCtr);

    outportb(0x20, 0x20); /* EOI (End-Of-Interrupt) to the master 8259A PIC */
}
/*..........................................................................*/
#if 0
/* The following alternative implementation of the ISR requires defining
* the macro QF_ISR_NEST in "qpn_port.h" to allow interrupt nesting.
*/
static void interrupt tickISR() {                             /* see NOTE02 */
    /*clear any level-sensitive interrupt sources before enabling interrupts*/
    enable();                                   /* enable interrupt nesting */

    QF_tick();                          /* process all time events (timers) */
    Video_printNumAt(20, 17, VIDEO_FGND_YELLOW, ++l_tickCtr);

    disable();        /* disable interrupts for the exit from the interrupt */
    outportb(0x20, 0x20); /* EOI (End-Of-Interrupt) to the master 8259A PIC */
}
#endif
/*..........................................................................*/
...
* interrupts are never unlocked (the 80x86 locks interrupts upon recognizing
* an interrupt). Not allowing interrupts to nest is consistent with the fact
* that the macro QF_INT_NEST is NOT defined in the qpn_port.h header file.
*
* NOTE02
...
* nesting, you need to unlock the interrupts inside the ISR, and you MUST

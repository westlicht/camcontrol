;*****************************************************************************
; Product: QK-nano port to Cortex-M3, IAR ARM assembler
; Last Updated for Version: 3.5.00
; Date of the Last Update:  Mar 18, 2008
;
...
;*****************************************************************************
    ...
    EXTERN  QF_readySet_      ; external references
...
;*****************************************************************************
QK_PendSV
    LDR     r0,=QF_readySet_  ; load the address of QF_readySet_
    LDRB    r0,[r0]           ; load the value of QF_readySet_
    CBZ     r0,iret           ; if QF_readySet_ == 0, return from interrupt
